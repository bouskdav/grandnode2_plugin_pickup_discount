...
namespace DiscountRules.Pickup.Controllers
{
    [Area("Admin")]
    [AuthorizeAdmin]
    public class PickupDiscountController : BasePluginController
    {
        private readonly IDiscountService _discountService;
        private readonly IGroupService _groupService;
        private readonly IPermissionService _permissionService;

        public PickupDiscountController(
        ...
        public async Task<IActionResult> Configure(string discountId, string discountRequirementId, string customerGroupId)
        {
            ...
            else
            {
                ...
                discountRequirement = new DiscountRule {
                    DiscountRequirementRuleSystemName = "DiscountRules.Pickup.ShippingPointDeliveryIsSelected",
