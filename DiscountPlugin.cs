...
namespace DiscountRules.Pickup
{
    public class DiscountPlugin : BasePlugin, IPlugin
    {
        ...
        public override async Task Install()
        {
            ...
            ////HadSpentAmount
            //await this.AddOrUpdatePluginTranslateResource(_translationService, _languageService, "Plugins.DiscountRules.Pickup.HadSpentAmount.Fields.Amount", "Required spent amount");
            //await this.AddOrUpdatePluginTranslateResource(_translationService, _languageService, "Plugins.DiscountRules.Pickup.HadSpentAmount.Fields.Amount.Hint", "Discount will be applied if customer has spent/purchased x.xx amount.");
        ...
        public override async Task Uninstall()
        {
            ...
            ////HadSpentAmount
            //await this.DeletePluginTranslationResource(_translationService, _languageService, "Plugins.DiscountRules.Pickup.HadSpentAmount.Fields.Amount");
            //await this.DeletePluginTranslationResource(_translationService, _languageService, "Plugins.DiscountRules.Pickup.HadSpentAmount.Fields.Amount.Hint");
